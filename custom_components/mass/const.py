...
CONF_TIDAL_ENABLED = "tidal_enabled"
CONF_TIDAL_USERNAME = "tidal_username"
CONF_TIDAL_PASSWORD = "tidal_password"
...
BLACKLIST_DOMAINS = (ATV_DOMAIN, ALEXA_DOMAIN, UNIVERSAL_DOMAIN, SPOTIFY_DOMAIN, TIDAL_DOMAIN)
